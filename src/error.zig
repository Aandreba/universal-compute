...
pub const uc_error_t = std.meta.Int(.signed, std.math.ceilPowerOfTwo(u16, @bitSizeOf(anyerror) + 1) catch unreachable);
...
pub export fn ucErrorName(e: uc_error_t, raw_name: [*]u8, name_len: usize) usize {
...
pub fn externError(e: anyerror) uc_error_t {
    return -@intCast(uc_error_t, @errorToInt(e));
}
